  ...
  <div class="mt-4">
    ...
    <div class="space-y-6">
      ...
      <div
        ...
        <div class="flex flex-wrap items-center gap-2">
          <UButton label="개발자노트" color="purple" variant="soft" icon="i-heroicons-code-bracket"
      ...
      <div class="flex flex-wrap gap-2 overflow-x-auto pb-2 scrollbar-hide">
        <UButton label="학급 설정" icon="i-heroicons-cog-6-tooth" color="blue" @click="handleOpenSettings"
          ...
          <div class="mt-6 space-y-6 bg-gray-50/50 p-6 rounded-[32px] border border-gray-100">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-1.5">
                <label class="text-[10px] font-black text-gray-400 uppercase t              <div class=" bg-blue-50/50
    ...
    <UModal v-model="isSettingModalOpen" :ui="{ width: 'max-w-xl' }">
      <div class="p-8 space-y-8">
        ...
        <div class="space-y-6">
          ...
          <UButton label="설정 저장하기" block color="blue" size="xl"
    ...
    <UModal v-model="isDevNoteModalOpen">
      <div class="p-8 space-y-6">
        <div class="flex items-center justify-between">
          <h3 class="text-xl font-black text-gray-800 flex items-center gap-2">
            <span class="i-heroicons-code-bracket w-6 h-6 text-purple-600" />
            개발자 노트
          </h3>
          <UButton icon="i-heroicons-x-mark" color="gray" variant="ghost" circular
        ...
        <div class="space-y-4">
          <div class="bg-purple-50 p-6 rounded-3xl border border-purple-100">
            <h4 class="font-black text-purple-900 mb-2 flex items-center gap-2">
              <span class="i-heroicons-sparkles-solid w-4 h-4" />
              우대 금리 지급 방식 변경 안내
            </h4>
            <div class="text-sm text-purple-800 leading-relaxed font-medium space-y-3">
              <p>적금 만기 시 지급되는 '1등급 우대 금리'의 적용 방식이 더욱 공정하게 개선되었습니다.</p>

              <ul class="list-disc list-inside space-y-1 ml-2">
                <li><span class="font-black text-purple-900">기존:</span> 적금 가입 시점의 신용등급을 기준으로 만기 이자 확정</li>
                <li><span class="font-black text-red-600">변경:</span> <b>만기 시점의 현재 신용등급</b>을 기준으로 우대 적용 여부 결정</li>
              </ul>

              <p class="bg-white/50 p-3 rounded-xl border border-purple-200 text-xs">
                이제 학생이 가입 당시에 1등급이었더라도, 만기 이전에 신용등급이 하락(2~10등급)한다면 <b>만기 우대 혜택을 받을 수 없습니다.</b> 성실한 활동을 끝까지 유지할 수 있도록 지도해
                주세요.
              </p>
            </div>
          </div>
        ...
        <UButton label="확인했습니다" block color="purple" size="xl"
          class="h-16 rounded-[24px] font-black text-lg shadow-xl shadow-purple-100"
          @click="isDevNoteModalOpen = false" />
      </div>
    </UModal>
