import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-C0JSsxJH.mjs';
import { r as useState, a as __nuxt_component_0$2, g as useRuntimeConfig } from '../server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CHW5LDvq.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-GyTfMVr6.mjs.map
