import { defineComponent, computed, ref, h, resolveComponent, hasInjectionContext, inject, useAttrs, toValue, getCurrentInstance, toRef, isRef, watch, withAsyncContext, mergeProps, unref, createVNode, resolveDynamicComponent, withCtx, renderSlot, watchEffect, version, defineAsyncComponent, useSSRContext, provide, shallowReactive, Suspense, nextTick, Transition, createApp, onErrorCaptured, onServerPrefetch, reactive, effectScope, shallowRef, isReadonly, isReactive, toRaw, isShallow, createBlock, createCommentVNode, openBlock, toDisplayString, createTextVNode } from 'vue';
import { B as defuFn, C as hasProtocol, j as joinURL, D as parseURL, E as parseQuery, h as createError$1, m as defu, F as createDefu, G as klona, H as withQuery, I as isScriptProtocol, J as withTrailingSlash, t as withoutTrailingSlash, K as sanitizeStatusCode, L as isEqual, d as useRuntimeConfig$1, $ as $fetch, M as createHooks } from '../nitro/node-server.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrInterpolate, ssrRenderSuspense, ssrRenderList, ssrRenderClass } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-qhwQygdb.mjs').then((m) => m.default || m)
  },
  {
    name: "articles",
    path: "/articles",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-BLeF9jDO.mjs').then((m) => m.default || m)
  },
  {
    name: "bookmarks",
    path: "/bookmarks",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/bookmarks-ZmnCc8EC.mjs').then((m) => m.default || m)
  },
  {
    name: "expense",
    path: "/expense",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/expense-B1j5CYeN.mjs').then((m) => m.default || m)
  },
  {
    name: "income",
    path: "/income",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/income-C3d2rdWq.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-_2YoOars.mjs').then((m) => m.default || m)
  },
  {
    name: "lab",
    path: "/lab",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/lab-DUc2vDhC.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/login-Ezyb6znk.mjs').then((m) => m.default || m)
  },
  {
    name: "penalty",
    path: "/penalty",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/penalty-bSidDeRv.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projects-BaWcJkvs.mjs').then((m) => m.default || m)
  },
  {
    name: "sign-id",
    path: "/sign/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-D59c94CE.mjs').then((m) => m.default || m)
  },
  {
    name: "tax",
    path: "/tax",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/tax-pbpnG8UX.mjs').then((m) => m.default || m)
  },
  {
    name: "transfer",
    path: "/transfer",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/transfer-Bl5wAHYz.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/whats-in-my-bag-YNtyqW8c.mjs').then((m) => m.default || m)
  }
];
...
const inlineConfig = {
  "nuxt": {
    "buildId": "57ff6159-ef3e-4597-a469-88667d5a5288"
  },
  "ui": {
    "primary": "green",
    "gray": "cool",
...
const LazyAnimatedCounter = defineAsyncComponent(() => import('./_nuxt/AnimatedCounter-n4tDNyte.mjs').then((r) => r.default));
const LazyCodeView = defineAsyncComponent(() => import('./_nuxt/CodeView-MTyAn4HH.mjs').then((r) => r.default));
const LazyCredit = defineAsyncComponent(() => import('./_nuxt/Credit-DHWJYWxb.mjs').then((r) => r.default));
...
const LazyLabCard = defineAsyncComponent(() => import('./_nuxt/LabCard-D4tHBlfd.mjs').then((r) => r.default));
const LazyRocket = defineAsyncComponent(() => import('./_nuxt/Rocket-BlFB1v7n.mjs').then((r) => r.default));
const LazyShapes = defineAsyncComponent(() => import('./_nuxt/Shapes-BmY0byxR.mjs').then((r) => r.default));
const LazyTextRotator = defineAsyncComponent(() => import('./_nuxt/TextRotator-CSL7tLoi.mjs').then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-BKPgjIRH.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-BnpPR_aw.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-DskJsXQo.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-C-8IlGAf.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-BlDnnZ8m.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-kmYXpPSN.mjs').then((r) => r.default));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-D_59-VPx.mjs').then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import('./_nuxt/ProsePre-BCe7-UHp.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-Jt8l2yMn.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-C_eyQOMN.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-ySAyym_S.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-CmN4kPRJ.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-nK-9plXK.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-YwMZstKh.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-DNO-C8Na.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-DcOy67lr.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-B2dODFg7.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-D7HXu5Sj.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-I-k8Flz3.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-CLt8erTL.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-BbkArePq.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-DFrAmVjB.mjs').then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import('./_nuxt/ProseScript-D0R07iM6.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-CSnM1WJR.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-DxNUp_xz.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-B6zhwSXA.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-PyW3LPAO.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-DgdbC-N9.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-DqrY2xOW.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-BCRMG5Eh.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-2f0MRhTP.mjs').then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Icon;
}).then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-YzNyIjTY.mjs').then((r) => r.default));
...
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$4]]);
...
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$3]]);
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_0;
      const _component_AppThemeToggle = _sfc_main$6;
      _push(`<div${ssrRenderAttrs(mergeProps({
        ref_key: "headerRef",
        ref: headerRef,
        style: unref(styles),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-D93036xP.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-CrGyLXN0.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-C5fcKdTZ.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useRoute as b, createError as c, useSeoMeta as d, entry$1 as default, useUI as e, appConfig as f, get as g, useRuntimeConfig as h, input as i, useNuxtApp as j, asyncDataDefaults as k, looseToNumber as l, mergeConfig as m, __nuxt_component_0 as n, useAppConfig as o, __nuxt_component_0$1 as p, useState as q, resolveIconName as r, select as s, useHead as u };
