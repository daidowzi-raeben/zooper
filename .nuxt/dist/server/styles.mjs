...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.ri8bzq9q.mjs').then(interopDefault),
  ...
  "pages/income.vue": () => import('./_nuxt/income-styles.Cun2hQCT.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.Cec3LLVq.mjs').then(interopDefault),
