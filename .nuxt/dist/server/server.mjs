import { hasInjectionContext, getCurrentInstance, reactive, effectScope, inject, unref, version, ref, watchEffect, watch, toRef, h, nextTick, shallowRef, shallowReactive, isReadonly, isReactive, toRaw, isRef, isShallow, defineAsyncComponent, computed, defineComponent, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, useSSRContext, withAsyncContext, createBlock, createCommentVNode, openBlock, toDisplayString, useAttrs, toValue, provide, Suspense, Transition, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import { START_LOCATION, createMemoryHistory, createRouter, RouterView, useRoute as useRoute$1, useRouter as useRouter$1 } from "vue-router";
...
import { ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_slug_-DtKeEgx9.js").then((m) => m.default || m)
  },
  {
    name: "articles",
    path: "/articles",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-DKs8Dn4K.js").then((m) => m.default || m)
  },
  {
    name: "bookmarks",
    path: "/bookmarks",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/bookmarks-u-J4ZFjs.js").then((m) => m.default || m)
  },
  {
    name: "expense",
    path: "/expense",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/expense-DUY9zwa4.js").then((m) => m.default || m)
  },
  {
    name: "income",
    path: "/income",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/income-CY8OO_Li.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-BuMnf2hX.js").then((m) => m.default || m)
  },
  {
    name: "lab",
    path: "/lab",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/lab-DDXOszfj.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-DLv8r4on.js").then((m) => m.default || m)
  },
  {
    name: "penalty",
    path: "/penalty",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/penalty-FIzvXfCD.js").then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/projects-DjIxBoT9.js").then((m) => m.default || m)
  },
  {
    name: "sign-id",
    path: "/sign/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-Dji4SPEF.js").then((m) => m.default || m)
  },
  {
    name: "signUp",
    path: "/signUp",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/signUp-Gb3vSrrO.js").then((m) => m.default || m)
  },
  {
    name: "tax",
    path: "/tax",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/tax-CZQZtQkl.js").then((m) => m.default || m)
  },
  {
    name: "teacher-id",
    path: "/teacher/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-BojJJWqf.js").then((m) => m.default || m)
  },
  {
    name: "teacher",
    path: "/teacher",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-D0phq7L8.js").then((m) => m.default || m)
  },
  {
    name: "teacher-login",
    path: "/teacher/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-DXYfMPLg.js").then((m) => m.default || m)
  },
  {
    name: "transfer",
    path: "/transfer",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/transfer-CaHjUYJq.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/whats-in-my-bag-M4aQPTwa.js").then((m) => m.default || m)
  }
];
...
const LazyAnimatedCounter = defineAsyncComponent(() => import("./_nuxt/AnimatedCounter--OG7f6GX.js").then((r) => r.default));
const LazyCodeView = defineAsyncComponent(() => import("./_nuxt/CodeView-Bs6rm8K2.js").then((r) => r.default));
const LazyCredit = defineAsyncComponent(() => import("./_nuxt/Credit-u9K0JTMi.js").then((r) => r.default));
...
const LazyLabCard = defineAsyncComponent(() => import("./_nuxt/LabCard-1hGCkn_I.js").then((r) => r.default));
const LazyRocket = defineAsyncComponent(() => import("./_nuxt/Rocket-D_oSfI8_.js").then((r) => r.default));
const LazyShapes = defineAsyncComponent(() => import("./_nuxt/Shapes-IAcLKu4H.js").then((r) => r.default));
const LazyTextRotator = defineAsyncComponent(() => import("./_nuxt/TextRotator-DHjQ5NwX.js").then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-BpOTug_p.js").then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-BhRqgn8-.js").then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-GyTfMVr6.js").then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-ConCPHmT.js").then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-D3XXg9Ku.js").then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-CbGdL-Lr.js").then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import("./_nuxt/ContentSlot-DRdVY1wy.js").then((r) => r.default));
...
const LazyMarkdown = defineAsyncComponent(() => import("./_nuxt/Markdown-Dr-sLt0C.js").then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/ProseCode-BtVDNCpJ.js").then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import("./_nuxt/ProseCodeInline-BBnbxtA7.js").then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import("./_nuxt/ProsePre-BCe7-UHp.js").then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-BKO8L-hQ.js").then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-BdXknQzo.js").then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/ProseEm-BNMNspAf.js").then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-BxetWIeI.js").then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-NKjaUoKX.js").then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-BZ7fXiJW.js").then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-Qs8zUr2d.js").then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-DRmWK3kj.js").then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-BZZmYQBF.js").then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-BVKgiA3X.js").then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-BKXvtlf4.js").then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/ProseLi-NmPeR4fn.js").then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/ProseOl-DmByT3-F.js").then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/ProseP-D7p_kL6_.js").then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import("./_nuxt/ProseScript-D0R07iM6.js").then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-BM0Lc6oQ.js").then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-w3Bxtgqu.js").then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-ClhMcIx3.js").then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-58RUsqTq.js").then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-BY3Iuphj.js").then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/ProseThead-CjTjrFEl.js").then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/ProseTr-BtnpKvjU.js").then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/ProseUl-CkHy6VOB.js").then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Icon;
}).then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-B6sj95hI.js").then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-JKBKdwxL.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-u598zsgD.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-CffaCdk_.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
