import { ref, watchEffect, defineComponent, computed, onMounted, onUnmounted, h as h$1, Fragment, watch, provide, inject, Teleport, reactive, unref, shallowRef, nextTick, normalizeClass, resolveComponent, mergeProps, withCtx, createVNode, renderSlot, createBlock, createCommentVNode, openBlock, toRef, useSSRContext } from "vue";
...
import { w as w$1, c as c$1, m as m$3, H, f as f$1, a as a$2, S as S$1, o, t as t$1, u as u$2, P as P$1, N as N$2, T, b as t$2, d as t$3, e as o$1, p as p$3, l as l$2, y, g as N$3, h as o$2, C as C$1, i as S$2, j as c$2, k as T$1 } from "./disposables-ze0J46BC.js";
const modal = {
...
let ce$1 = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e2, { attrs: t2, slots: l2, expose: o$12 }) {
  ...
  function M2(a2) {
    ...
    E2 instanceof HTMLElement && E2.dataset.headlessuiFocusGuard !== "true" && (N$1(d2, E2) || (s.value ? P$1(o(r), u$2(c2.value, { [d$2.Forwards]: () => N$2.Next, [d$2.Backwards]: () => N$2.Previous }) | N$2.WrapAround, { relativeTo: a2.target }) : a2.target instanceof HTMLElement && S$1(a2.target)));
  }
  return () => {
    let a2 = {}, d2 = { ref: r, onKeydown: H$1, onFocusout: M2 }, { features: E2, initialFocus: g2, containers: X, ...O } = e2;
    return h$1(Fragment, [Boolean(E2 & 4) && h$1(f$1, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u2, features: a$2.Focusable }), H({ ourProps: d2, theirProps: { ...t2, ...O }, slot: a2, attrs: t2, slots: l2, name: "FocusTrap" }), Boolean(E2 & 4) && h$1(f$1, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u2, features: a$2.Focusable })]);
  };
} }), { features: A }), L$2 = [];
function x(e2) {
  ...
  return onMounted(() => i2.value = true), onUnmounted(() => i2.value = false), onMounted(() => {
    watch([t2, l2, o$12], (n2, m2) => {
      ...
      c2 && t$1(() => {
        ...
        if (!i2.value)
          return;
        let u2 = o(l2), s = (H2 = e2.value) == null ? void 0 : H2.activeElement;
        if (u2) {
          if (u2 === s) {
            r.value = s;
            return;
...
let U = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(t2, { slots: e2, attrs: u2 }) {
  ...
  return onMounted(() => {
    ...
    return h$1(Teleport, { to: o$12.value }, H({ ourProps: a2, theirProps: t2, slot: {}, attrs: u2, slots: e2, name: "Portal" }));
  };
...
defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${t$2()}` } }, setup(t2, { attrs: i2, slots: o2 }) {
  ...
  return onMounted(() => onUnmounted(e2.register(t2.id))), () => {
    ...
    return H({ ourProps: c2, theirProps: l2, slot: n2.value, attrs: i2, slots: o2, name: s });
  };
} });
function m$2(t2) {
...
function p({ defaultContainers: t2 = [], portals: o$12, mainTreeNodeRef: s } = {}) {
  ...
  function u2() {
    ...
    for (let e2 of (l2 = r == null ? void 0 : r.querySelectorAll("html > *, body > *")) != null ? l2 : [])
      e2 !== (void 0).body && e2 !== (void 0).head && e2 instanceof HTMLElement && e2.id !== "headlessui-portal-root" && (e2.contains(o(i2)) || n2.some((c2) => e2.contains(c2)) || n2.push(e2));
    return n2;
  }
...
let M = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ue = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: M }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${t$2()}` } }, emits: { close: (o2) => true }, setup(o$12, { emit: n2, attrs: t2, slots: u2, expose: i2 }) {
  ...
  })] }), J2 = computed(() => E2.value ? "parent" : "leaf"), H$1 = computed(() => p$12 !== null ? (p$12.value & l$2.Closing) === l$2.Closing : false), Q2 = computed(() => $ || H$1.value ? false : R2.value), X = computed(() => {
    var e2, l2, f2;
    return (f2 = Array.from((l2 = (e2 = T2.value) == null ? void 0 : e2.querySelectorAll("body > *")) != null ? l2 : []).find((d2) => d2.id === "headlessui-portal-root" ? false : d2.contains(o(j)) && d2 instanceof HTMLElement)) != null ? f2 : null;
  });
  E$1(X, Q2);
  let Z = computed(() => E2.value ? true : R2.value), ee = computed(() => {
    var e2, l2, f2;
    return (f2 = Array.from((l2 = (e2 = T2.value) == null ? void 0 : e2.querySelectorAll("[data-headlessui-portal]")) != null ? l2 : []).find((d2) => d2.contains(o(j)) && d2 instanceof HTMLElement)) != null ? f2 : null;
  });
...
defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${t$2()}` } }, inheritAttrs: false, setup(o2, { attrs: n2, slots: t2, expose: u2 }) {
  ...
  return u2({ el: r, $el: r }), onMounted(() => {
    ...
    return h$1(P, { force: true }, () => h$1(U, () => H({ ourProps: m2, theirProps: { ...n2, ...p2 }, slot: { open: i2.dialogState.value === 0 }, attrs: n2, slots: t2, name: "DialogBackdrop" })));
  };
} });
...
function L$1(e2, t2, i2, n2, a2, l$12) {
  let s = o$1(), o2 = l$12 !== void 0 ? l(l$12) : () => {
  };
...
let W = N$3.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e2, { emit: t2, attrs: a2, slots: s, expose: h2 }) {
  ...
  onMounted(() => {
    ...
    if (b2.value === S$2.Hidden && c2) {
      ...
      u$2(i2.value, { ["hidden"]: () => H$1(c2), ["visible"]: () => D(c2) });
    }
  });
  ...
  return onMounted(() => {
    ...
    return H({ ourProps: { ...b2, as: "template" }, theirProps: {}, slot: {}, slots: { ...s, default: () => [h$1(ce, { onBeforeEnter: () => t2("beforeEnter"), onAfterEnter: () => t2("afterEnter"), onBeforeLeave: () => t2("beforeLeave"), onAfterLeave: () => t2("afterLeave"), ...a2, ...b2, ...d2 }, s.default)] }, attrs: {}, features: W, visible: r.value === "visible", name: "Transition" });
  };
} });
...
//# sourceMappingURL=Modal-BsfxzNKR.js.map
