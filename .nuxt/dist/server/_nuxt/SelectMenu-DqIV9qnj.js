...
import { _ as __nuxt_component_1$1 } from "./Avatar-C3pGi2x7.js";
import { isRef, ref, shallowRef, watchEffect, computed, onMounted, defineComponent, watch, onUnmounted, nextTick, provide, h, Fragment, inject, toRaw, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, renderList, createTextVNode, Transition, toRef, useSSRContext } from "vue";
import { n as noop, u as useFormGroup, a as useDebounceFn } from "./Input-OFElHbVA.js";
import { defu } from "defu";
import { twMerge, twJoin } from "tailwind-merge";
import { _ as _export_sfc, m as mergeConfig, j as useUI, k as appConfig, s as select, q as get } from "../server.mjs";
import { u as useInjectButtonGroup } from "./Button-BkeWMuC1.js";
...
import { o as o$2, m, b as t, H, u as u$1, p as p$2, l, k as T, y, j as c, f as f$2, K, O, a as a$2, g as N, h as o$3, e as o$4, n, q as w, r as h$1 } from "./disposables-ze0J46BC.js";
const arrow$1 = {
...
let Je = defineComponent({ name: "Combobox", emits: { "update:modelValue": (l2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => Oe }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, nullable: { type: Boolean, default: false }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(l$1, { slots: y$1, attrs: r2, emit: w2 }) {
  ...
  function j(n2 = (u2) => u2) {
    let u2 = O$1.value !== null ? v.value[O$1.value] : null, s = O(n2(v.value.slice()), (f2) => o$2(f2.dataRef.domRef)), a2 = u2 ? s.indexOf(u2) : null;
  ...
  let k = computed(() => l$1.multiple ? 1 : 0), m2 = computed(() => l$1.nullable), [o2, h$12] = d(computed(() => l$1.modelValue), (n2) => w2("update:modelValue", n2), computed(() => l$1.defaultValue)), C = computed(() => o2.value === void 0 ? u$1(k.value, { [1]: [], [0]: void 0 }) : o2.value), E = null, R = null, i = { comboboxState: e$1, value: C, mode: k, compare(n2, u2) {
    ...
    v.value = a2.options, O$1.value = a2.activeOptionIndex, I.value = 1, a2.options.some((f2) => !o$2(f2.dataRef.domRef)) && (R = requestAnimationFrame(() => {
      let f2 = j();
  ...
  y([S, p2, d$1], () => i.closeCombobox(), computed(() => e$1.value === 0)), provide(Y, i), c(computed(() => u$1(e$1.value, { [0]: l.Open, [1]: l.Closed })));
  let A2 = computed(() => i.activeOptionIndex.value === null ? null : v.value[i.activeOptionIndex.value].dataRef.value), F = computed(() => {
    var n2;
    return (n2 = o$2(S)) == null ? void 0 : n2.closest("form");
  });
  return onMounted(() => {
    watch([F], () => {
    ...
    return h(Fragment, [...n2 != null && C.value != null ? e({ [n2]: C.value }).map(([T2, B]) => h(f$2, K({ features: a$2.Hidden, key: T2, as: "input", type: "hidden", hidden: true, readOnly: true, form: s, name: T2, value: B }))) : [], H({ theirProps: { ...r2, ...T(a2, ["modelValue", "defaultValue", "nullable", "multiple", "onUpdate:modelValue", "by"]) }, ourProps: {}, slot: f2, slots: y$1, attrs: r2, name: "Combobox" })]);
  };
} });
defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: () => `headlessui-combobox-label-${t()}` } }, setup(l2, { attrs: y2, slots: r2 }) {
  let w2 = $$1("ComboboxLabel");
  function e2() {
    var t2;
    (t2 = o$2(w2.inputRef)) == null || t2.focus({ preventScroll: true });
  }
  return () => {
    let t2 = { open: w2.comboboxState.value === 0, disabled: w2.disabled.value }, { id: S, ...p2 } = l2, d2 = { id: S, ref: w2.labelRef, onClick: e2 };
    return H({ ourProps: d2, theirProps: p2, slot: t2, attrs: y2, slots: r2, name: "ComboboxLabel" });
  };
} });
let Ge = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-combobox-button-${t()}` } }, setup(l2, { attrs: y2, slots: r2, expose: w2 }) {
  ...
  return () => {
    var I, P;
    let d2 = { open: e2.comboboxState.value === 0, disabled: e2.disabled.value, value: e2.value.value }, { id: b2, ...v } = l2, O2 = { ref: e2.buttonRef, id: b2, type: p2.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (I = o$2(e2.optionsRef)) == null ? void 0 : I.id, "aria-expanded": e2.comboboxState.value === 0, "aria-labelledby": e2.labelRef.value ? [(P = o$2(e2.labelRef)) == null ? void 0 : P.id, b2].join(" ") : void 0, disabled: e2.disabled.value === true ? true : void 0, onKeydown: S, onClick: t2 };
    return H({ ourProps: O2, theirProps: v, slot: d2, attrs: y2, slots: r2, name: "ComboboxButton" });
  };
} }), Qe = defineComponent({ name: "ComboboxInput", props: { as: { type: [Object, String], default: "input" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, displayValue: { type: Function }, defaultValue: { type: String, default: void 0 }, id: { type: String, default: () => `headlessui-combobox-input-${t()}` } }, emits: { change: (l2) => true }, setup(l2, { emit: y2, attrs: r2, slots: w2, expose: e2 }) {
  let t2 = $$1("ComboboxInput"), S = computed(() => m(o$2(t2.inputRef))), p2 = { value: false };
  e2({ el: t2.inputRef, $el: t2.inputRef });
  function d2() {
    t2.change(null);
    let o2 = o$2(t2.optionsRef);
    o2 && (o2.scrollTop = 0), t2.goToOption(a$1.Nothing);
  }
  let b2 = computed(() => {
    var h2;
    let o2 = t2.value.value;
    return o$2(t2.inputRef) ? typeof l2.displayValue != "undefined" && o2 !== void 0 ? (h2 = l2.displayValue(o2)) != null ? h2 : "" : typeof o2 == "string" ? o2 : "" : "";
  });
  onMounted(() => {
    watch([b2, t2.comboboxState, S], ([o2, h2], [C, E]) => {
      if (p2.value)
        return;
      let R = o$2(t2.inputRef);
  ...
  return () => {
    var A2, F, n2, u2, s, a2;
    let o2 = { open: t2.comboboxState.value === 0 }, { id: h2, displayValue: C, onChange: E, ...R } = l2, i = { "aria-controls": (A2 = t2.optionsRef.value) == null ? void 0 : A2.id, "aria-expanded": t2.comboboxState.value === 0, "aria-activedescendant": t2.activeOptionIndex.value === null || (F = t2.options.value[t2.activeOptionIndex.value]) == null ? void 0 : F.id, "aria-labelledby": (s = (n2 = o$2(t2.labelRef)) == null ? void 0 : n2.id) != null ? s : (u2 = o$2(t2.buttonRef)) == null ? void 0 : u2.id, "aria-autocomplete": "list", id: h2, onCompositionstart: O2, onCompositionend: I, onKeydown: P, onInput: j, onBlur: k, role: "combobox", type: (a2 = r2.type) != null ? a2 : "text", tabIndex: 0, ref: t2.inputRef, defaultValue: m$1.value, disabled: t2.disabled.value === true ? true : void 0 };
    return H({ ourProps: i, theirProps: R, slot: o2, attrs: r2, slots: w2, features: N.RenderStrategy | N.Static, name: "ComboboxInput" });
  };
  ...
  let e2 = $$1("ComboboxOptions"), t$1 = `headlessui-combobox-options-${t()}`;
  ...
  return p$1({ container: computed(() => o$2(e2.optionsRef)), enabled: computed(() => e2.comboboxState.value === 0), accept(d2) {
    ...
    var O2, I, P;
    let d2 = { open: e2.comboboxState.value === 0 }, b2 = { "aria-labelledby": (P = (O2 = o$2(e2.labelRef)) == null ? void 0 : O2.id) != null ? P : (I = o$2(e2.buttonRef)) == null ? void 0 : I.id, id: t$1, ref: e2.optionsRef, role: "listbox", "aria-multiselectable": e2.mode.value === 1 ? true : void 0 }, v = T(l$1, ["hold"]);
    return H({ ourProps: b2, theirProps: v, slot: d2, attrs: y2, slots: r2, features: N.RenderStrategy | N.Static, visible: p2.value, name: "ComboboxOptions" });
  };
  ...
  let e2 = $$1("ComboboxOption"), t$1 = `headlessui-combobox-option-${t()}`, S = ref(null);
  w2({ el: S, $el: S });
  ...
  onMounted(() => e2.registerOption(t$1, b2)), onUnmounted(() => e2.unregisterOption(t$1)), watchEffect(() => {
    e2.comboboxState.value === 0 && p2.value && e2.activationTrigger.value !== 0 && nextTick(() => {
      var m2, o2;
      return (o2 = (m2 = o$2(S)) == null ? void 0 : m2.scrollIntoView) == null ? void 0 : o2.call(m2, { block: "nearest" });
    });
  });
  function v(m2) {
    if (l2.disabled)
    ...
    e2.selectOption(t$1), e2.mode.value === 0 && e2.closeCombobox(), n() || requestAnimationFrame(() => {
      var o2;
      return (o2 = o$2(e2.inputRef)) == null ? void 0 : o2.focus();
    });
  }
  function O2() {
    if (l2.disabled)
  ...
  return () => {
    ...
    return H({ ourProps: h2, theirProps: l2, slot: o2, attrs: r2, slots: y2, name: "ComboboxOption" });
  };
} });
let a = /([\u2700-\u27BF]|[\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2011-\u26FF]|\uD83E[\uDD10-\uDDFF])/g;
function o(e2) {
...
let Be = defineComponent({ name: "Listbox", emits: { "update:modelValue": (t2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(t2, { slots: v, attrs: l$1, emit: L }) {
  let e$1 = ref(1), d$1 = ref(null), b2 = ref(null), m2 = ref(null), f2 = ref([]), o2 = ref(""), i = ref(null), T$1 = ref(1);
  function k(a2 = (n2) => n2) {
    let n2 = i.value !== null ? f2.value[i.value] : null, u2 = O(a2(f2.value.slice()), (O2) => o$2(O2.dataRef.domRef)), s = n2 ? u2.indexOf(n2) : null;
    return s === -1 && (s = null), { options: u2, activeOptionIndex: s };
  }
  let y$1 = computed(() => t2.multiple ? 1 : 0), [h$2, M] = d(computed(() => t2.modelValue), (a2) => L("update:modelValue", a2), computed(() => t2.defaultValue)), w$1 = computed(() => h$2.value === void 0 ? u$1(y$1.value, { [1]: [], [0]: void 0 }) : h$2.value), r2 = { listboxState: e$1, value: w$1, mode: y$1, compare(a2, n2) {
    if (typeof t2.by == "string") {
      let u2 = t2.by;
      return (a2 == null ? void 0 : a2[u2]) === (n2 == null ? void 0 : n2[u2]);
    }
    return t2.by(a2, n2);
  }, orientation: computed(() => t2.horizontal ? "horizontal" : "vertical"), labelRef: d$1, buttonRef: b2, optionsRef: m2, disabled: computed(() => t2.disabled), options: f2, searchQuery: o2, activeOptionIndex: i, activationTrigger: T$1, closeListbox() {
    ...
    o2.value = "", i.value = O2, T$1.value = u2 != null ? u2 : 1, f2.value = s.options;
  }, search(a2) {
    if (t2.disabled || e$1.value === 1)
      return;
    let u2 = o2.value !== "" ? 0 : 1;
    ...
    f2.value = n2.options, i.value = n2.activeOptionIndex, T$1.value = 1;
  }, theirOnChange(a2) {
    t2.disabled || M(a2);
  }, select(a2) {
  ...
  y([b2, m2], (a2, n2) => {
    var u2;
    r2.closeListbox(), w(n2, h$1.Loose) || (a2.preventDefault(), (u2 = o$2(b2)) == null || u2.focus());
  }, computed(() => e$1.value === 0)), provide($, r2), c(computed(() => u$1(e$1.value, { [0]: l.Open, [1]: l.Closed })));
  let x$1 = computed(() => {
    var a2;
    return (a2 = o$2(b2)) == null ? void 0 : a2.closest("form");
  });
  return onMounted(() => {
    watch([x$1], () => {
    ...
    let { name: a2, modelValue: n2, disabled: u2, form: s, ...O2 } = t2, P = { open: e$1.value === 0, disabled: u2, value: w$1.value };
    return h(Fragment, [...a2 != null && w$1.value != null ? e({ [a2]: w$1.value }).map(([I, Q]) => h(f$2, K({ features: a$2.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: s, name: I, value: Q }))) : [], H({ ourProps: {}, theirProps: { ...l$1, ...T(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: P, slots: v, attrs: l$1, name: "Listbox" })]);
  };
} });
defineComponent({ name: "ListboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: () => `headlessui-listbox-label-${t()}` } }, setup(t2, { attrs: v, slots: l2 }) {
  ...
  function e2() {
    var d2;
    (d2 = o$2(L.buttonRef)) == null || d2.focus({ preventScroll: true });
  }
  return () => {
    let d2 = { open: L.listboxState.value === 0, disabled: L.disabled.value }, { id: b2, ...m2 } = t2, f2 = { id: b2, ref: L.labelRef, onClick: e2 };
    return H({ ourProps: f2, theirProps: m2, slot: d2, attrs: v, slots: l2, name: "ListboxLabel" });
  };
} });
let Ne = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: () => `headlessui-listbox-button-${t()}` } }, setup(t2, { attrs: v, slots: l2, expose: L }) {
    ...
    switch (o2.key) {
      ...
      case o$3.ArrowDown:
        o2.preventDefault(), e2.openListbox(), nextTick(() => {
          var i;
          (i = o$2(e2.optionsRef)) == null || i.focus({ preventScroll: true }), e2.value.value || e2.goToOption(a$1.First);
        });
        break;
      case o$3.ArrowUp:
        o2.preventDefault(), e2.openListbox(), nextTick(() => {
          var i;
          (i = o$2(e2.optionsRef)) == null || i.focus({ preventScroll: true }), e2.value.value || e2.goToOption(a$1.Last);
        });
        break;
    }
  }
  ...
  function m2(o2) {
    e2.disabled.value || (e2.listboxState.value === 0 ? (e2.closeListbox(), nextTick(() => {
      var i;
      return (i = o$2(e2.buttonRef)) == null ? void 0 : i.focus({ preventScroll: true });
    })) : (o2.preventDefault(), e2.openListbox(), me(() => {
      var i;
      return (i = o$2(e2.optionsRef)) == null ? void 0 : i.focus({ preventScroll: true });
    })));
  }
  let f2 = b(computed(() => ({ as: t2.as, type: v.type })), e2.buttonRef);
  return () => {
    var y2, h2;
    let o2 = { open: e2.listboxState.value === 0, disabled: e2.disabled.value, value: e2.value.value }, { id: i, ...T2 } = t2, k = { ref: e2.buttonRef, id: i, type: f2.value, "aria-haspopup": "listbox", "aria-controls": (y2 = o$2(e2.optionsRef)) == null ? void 0 : y2.id, "aria-expanded": e2.listboxState.value === 0, "aria-labelledby": e2.labelRef.value ? [(h2 = o$2(e2.labelRef)) == null ? void 0 : h2.id, i].join(" ") : void 0, disabled: e2.disabled.value === true ? true : void 0, onKeydown: d2, onKeyup: b$1, onClick: m2 };
    return H({ ourProps: k, theirProps: T2, slot: o2, attrs: v, slots: l2, name: "ListboxButton" });
  };
  ...
  return () => {
    var y2, h2, M, w2;
    let o2 = { open: e2.listboxState.value === 0 }, { id: i, ...T2 } = t2, k = { "aria-activedescendant": e2.activeOptionIndex.value === null || (y2 = e2.options.value[e2.activeOptionIndex.value]) == null ? void 0 : y2.id, "aria-multiselectable": e2.mode.value === 1 ? true : void 0, "aria-labelledby": (w2 = (h2 = o$2(e2.labelRef)) == null ? void 0 : h2.id) != null ? w2 : (M = o$2(e2.buttonRef)) == null ? void 0 : M.id, "aria-orientation": e2.orientation.value, id: i, onKeydown: b2, role: "listbox", tabIndex: 0, ref: e2.optionsRef };
    return H({ ourProps: k, theirProps: T2, slot: o2, attrs: v, slots: l$1, features: N.RenderStrategy | N.Static, visible: f2.value, name: "ListboxOptions" });
  };
  ...
  onMounted(() => e2.registerOption(t2.id, i)), onUnmounted(() => e2.unregisterOption(t2.id)), onMounted(() => {
    ...
    e2.listboxState.value === 0 && b2.value && e2.activationTrigger.value !== 0 && nextTick(() => {
      var r2, x2;
      return (x2 = (r2 = o$2(d2)) == null ? void 0 : r2.scrollIntoView) == null ? void 0 : x2.call(r2, { block: "nearest" });
    });
  });
  function T2(r2) {
    if (t2.disabled)
    ...
    e2.select(t2.value), e2.mode.value === 0 && (e2.closeListbox(), nextTick(() => {
      var x2;
      return (x2 = o$2(e2.buttonRef)) == null ? void 0 : x2.focus({ preventScroll: true });
    }));
  }
  function k() {
    if (t2.disabled)
...
//# sourceMappingURL=SelectMenu-DqIV9qnj.js.map
