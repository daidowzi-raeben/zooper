...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (((_b = unref(friendToday)) == null ? void 0 : _b.result) === "FAIL") {
        ...
        _push(`<div class="rounded-2xl shadow-md p-4 bg-gradient-to-r from-blue-300 to-indigo-400 text-white text-center text-lg font-bold cursor-pointer"> \u2764\uFE0F\u2764\uFE0F ${ssrInterpolate((_d = (_c = unref(friendToday)) == null ? void 0 : _c.data) == null ? void 0 : _d.mb_name)} \u2764\uFE0F\u2764\uFE0F </div>`);
      }
      _push(`</div><div class="mt-8 rounded-2xl shadow-md border">`);
      if (((_e = unref(hopeToday)) == null ? void 0 : _e.result) === "FAIL") {
        ...
        _push(`<div class="rounded-2xl shadow-md p-4 bg-gradient-to-r from-purple-400 to-pink-500 text-white text-center text-lg font-bold cursor-pointer">${ssrInterpolate((_g = (_f = unref(hopeToday)) == null ? void 0 : _f.data) == null ? void 0 : _g.result_text)}</div>`);
      }
      _push(`</div></div>`);
    };
  }
...
//# sourceMappingURL=index-Mp7s2dPD.mjs.map
