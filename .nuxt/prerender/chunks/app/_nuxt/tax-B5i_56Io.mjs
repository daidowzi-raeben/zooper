...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h2 class="mb-3 font-bold">\uC138\uAE08 \uB0A9\uBD80 \uD558\uAE30</h2><div><div class="mb-6 flex items-center gap-3"><div class="flex-none rounded-full p-1 text-primary-500 bg-primary-500/10"><div class="h-1.5 w-1.5 rounded-full bg-current"></div></div><h2 class="uppercase text-xs font-semibold text-gray-400"> \uB098\uC758 \uC794\uC561 ${ssrInterpolate(memberPoint.value)}</h2></div><p class="mt-2 text-sm text-gray-600 dark:text-gray-400"> \uB0A9\uBD80\uD560 \uC138\uAE08\uC744 \uC785\uB825 \uD6C4 QR\uCF54\uB4DC\uB85C \uC778\uC99D \uD574 \uC8FC\uC138\uC694 </p><div class="flex items-center gap-3 mt-6">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/tax.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=tax-B5i_56Io.mjs.map
