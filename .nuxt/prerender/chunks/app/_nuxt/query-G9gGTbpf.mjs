import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///Users/jang-yeong-ug/Documents/zooper/node_modules/vue/index.mjs';
import { j as useNuxtApp, k as asyncDataDefaults, h as useRuntimeConfig, c as createError } from '../server.mjs';
import { withBase, withLeadingSlash, joinURL, withoutTrailingSlash } from 'file:///Users/jang-yeong-ug/Documents/zooper/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-iT71QHFI.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-G9gGTbpf.mjs.map
