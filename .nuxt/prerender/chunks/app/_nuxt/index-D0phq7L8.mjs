import { _ as __nuxt_component_0 } from './Modal-BsfxzNKR.mjs';
import { _ as __nuxt_component_2, h as hostUrl, a as apiPost, c as api, u as useFormGroup, b as apiPoint } from './api-DKaA_XRh.mjs';
import { _ as __nuxt_component_0$1, u as useInjectButtonGroup } from './Button-BkeWMuC1.mjs';
import { _ as __nuxt_component_1 } from './SelectMenu-DqIV9qnj.mjs';
import { _ as __nuxt_component_0$2 } from './Icon-DWHer77Q.mjs';
import { ref, watch, mergeProps, withCtx, createVNode, createTextVNode, unref, createBlock, createCommentVNode, openBlock, withDirectives, toDisplayString, vModelText, defineComponent, toRef, computed, useSSRContext } from 'file:///Users/jang-yeong-ug/Documents/zooper/node_modules/vue/index.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrRenderStyle, ssrIncludeBooleanAttr, ssrRenderSlot } from 'file:///Users/jang-yeong-ug/Documents/zooper/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="space-y-6"><div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-gray-100"><div><h1 class="text-2xl font-black text-gray-800 flex items-center gap-2"><span class="text-3xl">\u{1F44B}</span> ${ssrInterpolate((_a = teacherInfo.value) == null ? void 0 : _a.mb_name)} <span class="text-blue-500 text-lg font-bold">\uC120\uC0DD\uB2D8</span></h1><p class="text-sm text-gray-400 font-medium ml-10">\uADC0\uC5FC\uB465\uC774 6\uD559\uB144 \uCE5C\uAD6C\uB4E4\uACFC \uD568\uAED8\uD558\uB294 \uACBD\uC81C \uAD50\uC2E4</p></div><div class="flex items-center gap-2">`);
...
//# sourceMappingURL=index-D0phq7L8.mjs.map
