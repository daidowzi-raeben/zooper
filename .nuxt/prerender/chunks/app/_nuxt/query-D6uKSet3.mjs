...
import { i as useNuxtApp, j as asyncDataDefaults, h as useRuntimeConfig, c as createError } from '../server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Dd57Zc9l.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-D6uKSet3.mjs.map
