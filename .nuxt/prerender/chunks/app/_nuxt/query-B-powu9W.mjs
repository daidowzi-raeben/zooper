...
import { h as useNuxtApp, i as asyncDataDefaults, g as useRuntimeConfig, c as createError } from '../server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BWaMP3h7.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-B-powu9W.mjs.map
