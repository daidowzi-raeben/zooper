...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (((_b = unref(hopeToday)) == null ? void 0 : _b.result) === "FAIL") {
        ...
        _push(`<div class="rounded-2xl shadow-md p-4 bg-gradient-to-r from-purple-400 to-pink-500 text-white text-center text-lg font-bold cursor-pointer">${ssrInterpolate((_d = (_c = unref(hopeToday)) == null ? void 0 : _c.data) == null ? void 0 : _d.result_text)}</div>`);
      }
      _push(`</div></div>`);
    };
  }
...
//# sourceMappingURL=index-D-blzBsr.mjs.map
