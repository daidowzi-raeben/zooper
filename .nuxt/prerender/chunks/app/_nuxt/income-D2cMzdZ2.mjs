import { _ as __nuxt_component_1, a as apiPost, b as apiPoint } from './api-COUCO3sw.mjs';
...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderComponent, ssrRenderList } from 'file:///Users/jang-yeong-ug/Documents/zooper/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h2 class="mb-3 font-bold">\uC785\uAE08\uD558\uAE30</h2><div><div class="mb-6 flex items-center gap-3"><div class="flex-none rounded-full p-1 text-primary-500 bg-primary-500/10"><div class="h-1.5 w-1.5 rounded-full bg-current"></div></div><h2 class="uppercase text-xs font-semibold text-gray-400"> \uB098\uC758 \uC794\uC561 ${ssrInterpolate(memberPoint.value)}</h2></div><p class="mt-2 text-sm text-gray-600 dark:text-gray-400"> \uC785\uAE08\uC744 \uD558\uAE30 \uC704\uD574\uC120 <span style="${ssrRenderStyle({ "font-weight": "bold", "color": "red" })}">\uC740\uD589\uC6D0\uC758 \uC2B9\uC778</span>\uC774 \uD544\uC694\uD569\uB2C8\uB2E4. <br> \uC740\uD589\uC6D0 \uCE5C\uAD6C\uC640 \uD568\uAED8 \uC624\uC138\uC694. </p><div class="flex items-center gap-3 mt-6">`);
...
//# sourceMappingURL=income-D2cMzdZ2.mjs.map
